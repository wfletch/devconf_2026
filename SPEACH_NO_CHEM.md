...
00:00 -    So, without further pandering, let me tell you a story! But First. Who am I?
           ...
           the wonderful webscale world. In the past I've worked at Amazon, Oracle, and
...
03:00 -    Fortuantely, that itch was soon scratched when I joined HYENA as a Systems Engineer. A startup on the
           ...
           And we are doing just that, with a focus on the local African market and our rather unique electrical and geographic limitations.

           While I would love to spend my time today talking about the unique chemical, electrical, and mechanical properties
           involved with functionality of a Fuel cell. That will have to be for shelved in the intrest of time. But the executive summary, is that at HYENA, we
           <slide>
           ...
           Today, we use it for the the hydro part of hydro carbon. Hydrogen

           To get this hydrogen off the LPG, we heat it up to around 800 degress celsius, before running it over a collection of catalyts.

04:00      For the purposes of this talk, we are going to focus specifically on the production of hydrogen from LPG, and the consumption of hydrogen to produce Electricity.

           Specifically, the precise temperature control of a chemical reactor, as well as the required reactants. In our case. we need to keep it at about 800 degress celsius. The process of
           seperating the hydrogen from the carbon requires significant amounts of heat. For all those who have tinkered with hardware or are familiar with a raspberry pi.
           We need to use a mroe advanced system to control our hardware. Both in terms of precision and safety.
...
08:00 -    Industrial Automation.
           ...
           These projects very in size and complexity. But they are, above all, concerned with safety, longevity, and security.
           And hav been around for some time. Projets ranging from
           <slide>
           <Big project> to
           <slide>
           <small project> to
           ...
           <tiny project>
           <slide>
           function the way they do because of their reliance on the  Industrial Automatoin Industry. At home, we see it's use dominated by the mining, and agricultural
           sectors.
...
09:00 -    And this industry has been around for some time. Originally started in the late 1960s, it has only been growing since. Today, it's worth just under 270 Billion USD.
           ...
           And PLCs did one hell of a great job. This industry exploded, and many hardware manufactuers saw the commerical opportunity of producing and supporting such devices, along with the associated hardware they need.
...
12:00 -    What does this mean in a modern context
           ...
           While these systems advertise that they speak the same languages. They also ship their IDEs with just enough vendor specific oddities that your code would require some degree of a rewrite if you moved over to their competitor.

           Say what you will about oracle and their exorpatend prices for the Jave Enterprise JRE. At least they don't force to you use a specific processor.... yet.
...
15:00 -    So let's go back to a slightly younger version of myself.  Fresh off the boat of Web Scale, with it's exceptioanlly rich open-source ethos where comapanies
           ...
           <slide>
           I was tasked with the slightly scary job of building the control system we were going to use to achive our fuel-cell goals.
           ...
           But don't worry, this phenomenon also extends to hardware decelopment.
...
18:00 -    But it worked! We had our PoC. After 3 failed attempts
           ...
           <slide>
           and a lot of coffee.
           We hit our goal of running the system for 24 hours without any deal-breaker issues.

           In this process, we had started to get a hang of how our system worked. Both from a hardware and softare perspective.
           Ultimately version 1 was only about 500 lines of code or so. We had not sunk too many resources into this just yet.
